...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            application::commands::get_workspace_snapshot,
            application::commands::load_queue_reference_data,
            application::commands::load_workspace_health,
            application::commands::open_app_log_file,
            application::commands::reveal_app_log_file,
            application::commands::media_dedupe_status,
            application::commands::media_dedupe_summary_status,
            application::commands::media_dedupe_result_page,
            ...
            application::commands::load_library_dashboard,
            application::commands::load_variant_groups,
            application::commands::dismiss_variant_group,
            application::commands::list_collections,
            application::commands::upsert_collection,
            application::commands::delete_collection,
            application::commands::promote_collection_to_global,
            application::commands::add_profile_media_to_collection,
            application::commands::add_timeline_items_to_collection,
            application::commands::remove_timeline_items_from_collection,
            application::commands::load_collection_relative_paths,
            application::commands::load_collection_timeline,
            application::commands::load_media_timeline,
            application::commands::mark_timeline_seen,
            application::commands::list_identities,
            application::commands::create_identity,
            application::commands::delete_identity,
            application::commands::link_source_to_identity,
            application::commands::suggest_identity_links,
            application::commands::load_source_handle_history,
            application::commands::media_index_status,
            ...
            application::commands::single_videos_root_status,
            application::commands::set_single_videos_root,
            ...
            application::commands::open_library_window,
